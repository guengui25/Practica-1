...
const Quote: FunctionComponent<QuoteProps> = (props) => {
    ...
    <>
        ...
        <div class="publicidad" id="izq">
            ...
            <br></br>
            <img class = "multimedia" src="/sources/He-man.jpg" id="He-man" alt="Foto de He-Man" onClick="playSound('Heman-sound')" onmouseover="changeHeman()" onmouseout="restoreHeman()"></img>
        ...
        <div class="Center">
            <img src="/sources/Sonic.gif" id="Sonic" alt="Gif Sonic" onClick="moverSonic()"></img>
        ...
        <div class="publicidad" id="der">
            ...
            <br></br>
            <img id="Fart" src="/sources/fart.gif" onClick="playSound('Fart-sound')"></img>
